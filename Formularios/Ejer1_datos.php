<?php
    DEFINE("CAMPOSFORM",array("nom"=>["patron"=>"/.*/","size"=>"60","pal"=>"Nombre","patronUser"=>"Cualquier caracter alfanumerico"],
                              ...
                              "TelMovil"=> ["patron"=>"/[0-9]{9}/","size"=>"9","pal"=>"Telefono Movil","patronUser"=>"9 digitos"],
                              "pwd"=> ["patron"=>"/^(?=.*[a-z])(?=.*[^a-zA-Z0-9]).{8,}$/","size"=>"9","pal"=>"Contraseña","patronUser"=>"8 caracteres alfanumericos, al menos una minuscula y un caracter especial"]));
?>